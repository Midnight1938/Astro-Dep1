...
export default function Nav() {
    ...
    const matches = useMediaQuery("(min-width: 1028px)") // For hamburger hiding

    return (
        <nav className="relative mx-8 mb-24 flex justify-between items-center pt-8 pb-6 font-medium md:mx-16 lg:mx-32">
            <svg
            ...
            <div>
                <img src="/images/avatar.png" alt="Picture Profile of Human"/>
            </div>
            ...
            {/* ON and OFF hamburger, flips false to true */}
            {!matches && (
                <div
